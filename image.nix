# This file used to be an attempt to produce a self-contained SquashFS image for
# running Hoff, but it is broken when the Nix sandbox is enabled; it should be
# fixed at some point.
...
{ pkgs ?
  ...
  import (import ./nix/nixpkgs-pinned.nix) {}
}:
